...
A monitorização em nível utilizador pode ser efectuada de diferentes formas, como seja a simples introdução de código para monitorização no código fonte da aplicação. A instrumentação do código pode também ser efectuada utilizando a bibliotecas para o efeito (como \textit{Gnu Profiller}).

...
Na estrutura do processo existem apontadores para a árvore geneológica do processo, apontador para o pai (o processo que efectuou um \textit{fork}, para lhe dar origem), a lista de irmãos e de descententes.
...
\textit{AF\_INET} é a familia de endereços utilizada para comunicar através da \textit{internet}, utilizando para isso o protocolo \textit{IP versão 4} (ver figura \ref{}

...
%Os ``file descriptors'' são a abstração para os ``sockets''. Os sockets são %mapeados em ficheiros e estes em descritores de ficheiros. 
...
%Como os protocolos \textit{TCP} e \textit{UDP} partilham algumas das funcionalidades nem todas as f

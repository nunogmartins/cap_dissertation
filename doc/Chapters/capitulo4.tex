...
A chave de indexação das folhas é o número do porto, desta forma a árvore poderá conter no máximo 65535 elementos.
No pior caso, a procura de um porto na árvore necessitará de efectuar dezasseis iterações, uma vez que $$\log 2 65535 = 16 $$

...
\todo{falta escrever sobre tecnica do trampolim e dos handlers}
Para efectuar esta operação é utilizada a técnica do trampolim~\cite{Hollingsworth94dynamicprogram}, uma vez que uma função pode terminar em diversos pontos. e falar sobre o handler ...
...
\todo{normalização de estruturas}
...
A captura do tráfego, respeitante a um processo genérico, foi alvo de estudo em \cite{1688981} e em \cite{Farruca:2009}, esta última, uma dissertação de mestrado.

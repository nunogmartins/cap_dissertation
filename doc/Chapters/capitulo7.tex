...
Os fluxos capturados foram analisados na ferramenta \textit{WireShark}, através do ficheiro que contém os fluxos de rede das transferências, verificando-se que apenas os respeitantes a estes dois protocolos lá se encontravam.

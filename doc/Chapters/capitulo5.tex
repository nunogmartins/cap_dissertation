...
A implementação do \textit{MRoP} teve em consideração o desenvolvimento de um código que implicasse o de mínimo alterações ao código do núcleo e, simultaneamente, tirasse partido de \textit{APIs} internas.

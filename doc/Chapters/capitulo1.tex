...
\begin{itemize}
	...
	\item \textbf{Capítulo \ref{cap:avaliacao} - \nameref{cap:avaliacao} - } Avaliação funcional e de desempenho do \textit{MRoP} e dos seus componentes. Analise do desempenho do sistema de monitorização utilizado (\textit{KProbes}).

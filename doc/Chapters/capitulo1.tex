...
\todo{ver} Para além desta dificuldade, a monitorização de processos em nível utilizador nem sempre é possível de ser realizada, dado que para efectuar a instrumentação é necessário ter acesso ou conhecimento do código da aplicação.

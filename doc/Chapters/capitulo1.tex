...
A monitorização no núcleo pode gerar um excesso de informação que pode não se mostrar irrelevante para as análises efectuadas.
Se considerarmos que a passagem dos dados gerados pela monitorização, do núcleo para o nível utilizador, onde se localizam as ferramentas que procedem à sua análise, é necessário efectuar a cópia e proceder à filtragem dos eventos pretendidos, podemos estar perante uma sobrecarga do sistema.

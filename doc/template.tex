...
% Autor
\author[m]{Nuno Miguel Galvão Martins} 
\authordegree{Licenciatura}
...
\adviser[m]{Vítor Manuel Alves Duarte}{Prof.\ Auxiliar}{\\&Universidade Nova de Lisboa}
...
\chapterfile{capitulo1.tex}
\chapterfile{capitulo2.tex}
%\chapterfile[3]{capitulo3.tex}
\chapterfile{capitulo4.tex}
\chapterfile{capitulo5.tex}
\chapterfile{capitulo6.tex}
\chapterfile{capitulo7.tex}
